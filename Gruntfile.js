...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/page-bulider/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/page-bulider/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
        ...
        files: [
          {
            cwd: 'src/text',
            src: ['license.txt'],
            dest: 'dist/page-bulider',
            expand: true
          },
          { src: ['changelog.txt'], dest: 'dist/page-bulider', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/page-bulider/version.txt', BUILD_VERSION);
  });
